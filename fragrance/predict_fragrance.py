'''
Pyrfume dataset fragrance classification with Big MPNN.
'''
...
class Initialization:
    ...
    def init_args(self):
        ...
        parser.add_argument('--fold', type=int, help='Which fold from the 5-K-Fold do you want to validate on?')
...
def main():
    ...
    logger.debug('Training on %d molecules, testing on %d molecules', len(train_df),
                 len(test_df))
    ...
    logger.debug('----------- FOLD %d OF 5 -----------', fold_number + 1)
